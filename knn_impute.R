...
knn_impute <- function(x, k=NULL, distance=c("euclidean","manhattan","matching"), use=c("IC","CC"), fun=weighted.mean, integer=FALSE, standard=TRUE)
{
    distance <- distance[1]
...
na_impute <- function(x, margin=2, fun=mean, integer=FALSE, ...)
{
